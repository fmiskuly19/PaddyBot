...
module.exports.run = async (bot, message,args) => {
    ...
    reddit.getSubreddit('GamersRiseUp').getTop({time: 'day'}).then(function(response){
        if (typeof response === 'string' || response instanceof String){
            ...
            const embed = {
              ...
              m.edit("Here is the top post of the day from reddit.com/r/GamersRiseUp!",{embed});
        }
    });
};
...
module.exports.info = {
    name: "riseup",
    usage: ".riseup",
    description: "Gets top post of the day from reddit.com/r/GamersRiseUp"
};